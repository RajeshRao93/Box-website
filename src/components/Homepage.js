...
import './Homepage.css';
import { Nav, NavItem, Navbar, Badge, Jumbotron, Button, Card } from 'react-bootstrap';
            ...
            <div className="homepage">
                <div className="firstdiv" >
                    <Jumbotron style={{ backgroundImage: 'linear-gradient(45deg, white, #289FA5)', color: '#343a40ba' }}>
                        <h1 style={{ fontWeight: '900', fontFamily: 'cursive' }}><MDBIcon far icon="hand-spock" /> Hello!
                            <br />
                ...
                <div className="seconddiv">
                    <div className="card1" >
                        <Card onClick={this.moveNext} style={{ width: '18rem' }}>
                            <Card.Img variant="top" onMouseEnter={this.changewidth} onMouseLeave={this.changewidth}
                                src={image} />
